...
# define variables
args = {'output_datasource_type': '', 'sysparm': '', 'source': '/datasets/testing.csv', 'output_type': 'Localfile', 'execution_type': 'DSX', 'target': '/datasets/pred'}
...
model_path = os.getenv("DSX_PROJECT_DIR") + os.path.join("/models", os.getenv("DSX_MODEL_NAME","Telco_Churn_model"), os.getenv("DSX_MODEL_VERSION","1"),"model")
